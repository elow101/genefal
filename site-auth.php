...
function site_security_headers(bool $noStore = true): void
{
    ...
    header(
        "Content-Security-Policy: default-src 'none'; base-uri 'self'; object-src 'none'; frame-ancestors 'none'; form-action 'self'; connect-src 'self'; img-src 'self' data:; manifest-src 'self'; script-src 'self' 'nonce-{$styleNonce}'; script-src-attr 'none'; style-src 'self' 'nonce-{$styleNonce}'; style-src-elem 'self' 'nonce-{$styleNonce}'; style-src-attr 'unsafe-inline'; upgrade-insecure-requests"
    );
