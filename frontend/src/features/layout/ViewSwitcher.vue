    ...
    <div class="view-toggle" role="tablist" aria-label="Mode d'affichage">
      ...
      >
        <span class="view-tab-icon" :class="`view-tab-icon--${view.icon || view.id}`" aria-hidden="true">
          ...
          <svg v-else-if="view.icon === 'idea'" viewBox="0 0 24 24"><path d="M9 18h6" /><path d="M10 22h4" /><path d="M8.4 14.6A6 6 0 1 1 15.6 14.6c-.7.5-1.1 1.2-1.2 2H9.6c-.1-.8-.5-1.5-1.2-2Z" /></svg>
